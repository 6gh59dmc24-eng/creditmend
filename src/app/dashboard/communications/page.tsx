...
export default function CommunicationsPage() {
  ...
  const communications = [
    {
      ...
      content: "Your latest credit report from Experian has been uploaded to your portal. Please review and let us know if you have any questions.",
    ...
    },
    {
      ...
      content: "Hi, I wanted to check on the status of my dispute with the collection account. When can I expect to hear back from the credit bureau?",
    ...
    },
    {
      ...
      content: "Client needs to upload proof of address for the upcoming dispute. Discussed required documents and timeline.",
    ...
    },
    {
      ...
      content: "Your dispute letter for Experian has been generated and sent. Expected response time: 30 days.",
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      ...
      case "portal_message": return <MessageSquare className="h-4 w-4" />
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Send a message to your credit repair agent</CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <CardDescription className="flex items-center space-x-2">
                      <span className={`font-medium ${getDirectionColor(communication.direction)}`}>
                        {communication.sender}
                      </span>
                      <span className="text-gray-400">
                        {communication.direction === 'outbound' ? '→' : '←'} {communication.recipient || 'You'}
                      </span>
                    </CardDescription>
                  </div>
                </div>
